...
(async () => {
  ...
  await owner.evaluate((s) => {
    ...
    set(byPlaceholder('kirashi'), s);
    set(byPlaceholder('Fabricated galvanized materials'), 'Fabricated galvanized materials');
    set(byPlaceholder('11kV line hardware, made to spec'), '11kV line hardware, made to JBVNL spec');
  }, slug);
  await sleep(400);
